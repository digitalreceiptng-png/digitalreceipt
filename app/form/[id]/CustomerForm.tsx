        ...
        <Field label="Proof of Payment" required>
          ...
          {uploadProgress === 'done' && evidenceName ? (
            ...
            <button
              ...
              className="w-full border-2 border-dashed border-border hover:border-forest/40 rounded-xl px-4 py-6 text-center transition-colors group"
            >
              <Upload size={20} className="text-ink-dim group-hover:text-forest mx-auto mb-2 transition-colors" />
              <p className="text-sm text-ink-muted group-hover:text-ink transition-colors">Click to upload proof of payment</p>
