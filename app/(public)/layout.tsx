...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="bg-forest-light border-t border-forest/10 py-10 sm:py-14">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-heading text-2xl sm:text-3xl text-ink font-bold mb-2" style={{ letterSpacing: '-0.02em' }}>Get the App</h2>
          <p className="text-ink-muted text-sm mb-8">Download DigitalReceipt.ng on your preferred platform</p>
          <div className="flex flex-wrap justify-center gap-3">
            {/* Android */}
            <a
              href="https://play.google.com/store/apps/details?id=ng.digitalreceipt.merchant"
              target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-3 bg-[#1a3728] text-white px-5 py-3 rounded-xl hover:bg-[#2d5a3d] transition-colors shadow-sm"
            >
              <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76a2 2 0 001.94-.22l11.29-6.52-2.5-2.5-10.73 9.24zM.5 1.05A2 2 0 000 2.5v19a2 2 0 00.5 1.45L.6 23l10.66-10.66v-.25L.6 1.1l-.1-.05zM20.32 10.5l-2.6-1.5-2.83 2.83 2.83 2.83 2.63-1.52a2 2 0 000-2.64zM5.12.46L16.41 6.98l-2.5 2.5L3.18.24A2 2 0 005.12.46z"/></svg>
            ...
            <a
              href="#"
              className="flex items-center gap-3 bg-[#1a3728] text-white px-5 py-3 rounded-xl hover:bg-[#2d5a3d] transition-colors shadow-sm opacity-60 cursor-not-allowed"
              title="Coming soon"
            >
            ...
            <a
              ...
              title="Coming soon"
            >
              <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801"/></svg>
              <div className="text-left">
                <p className="text-[10px] opacity-70 leading-none">Coming soon on</p>
          ...
          <p className="text-xs text-ink-muted mt-6 opacity-60">Android app available now · iOS, Windows & macOS coming soon</p>
        </div>
      </section>
      ...
      <footer className="bg-sidebar text-white py-8 sm:py-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-start justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-3 text-sm text-white/50 text-center md:text-left w-full md:w-auto justify-center md:justify-start">
            ...
            <div className="flex flex-col gap-3 items-center md:items-start">
              ...
              <CopyEmailButton email="info@digitalreceipt.ng" />
              <div className="flex items-start gap-1.5 mt-1 justify-center md:justify-start">
                <svg className="w-3.5 h-3.5 text-white/50 mt-0.5 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 2C8.686 2 6 4.686 6 8c0 5.25 6 13 6 13s6-7.75 6-13c0-3.314-2.686-6-6-6zm0 8a2 2 0 110-4 2 2 0 010 4z"/></svg>
                <p className="text-xs text-white/40 leading-relaxed text-center md:text-left">4th Floor, Tower A, IHVN Tower<br />Jabi Airport Road, Abuja, FCT</p>
              </div>
            </div>
          </div>
