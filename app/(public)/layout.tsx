...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  const isDesktop = headersList.get('x-electron-desktop') === '1'
          ...
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex gap-1.5">
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 bg-[#1a3728] text-white px-3 py-2 rounded-xl transition-colors shadow-sm opacity-40 cursor-not-allowed pointer-events-none"
                  title="32-bit coming soon"
                  aria-disabled="true"
                >
                  <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801"/></svg>
                  <div className="text-left">
