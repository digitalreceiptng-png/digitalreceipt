    ...
    <div>
      ...
      <section className="w-full bg-forest overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
          ...
          {/* Image side */}
          <div className="w-full lg:w-[52%] shrink-0 self-stretch relative min-h-64 lg:min-h-0 bg-white">
            <Image
              src="/hero-image.png"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                n: '3',
                title: 'Verify',
                desc: 'Share the receipt link or identifier. Anyone can confirm it at DigitalReceipt.ng; no account required.',
              },
            ].map(({ n, title, desc }) => (
              <div
                key={title}
