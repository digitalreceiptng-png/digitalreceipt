...
export default async function ReceiptsPage({
  ...
  let query = db
    .from('receipts')
    .select('id, receipt_number, buyer_name, total_amount, balance_due, transaction_date, status, issued_by_staff_id, group_id, profiles!receipts_issued_by_staff_id_fkey(full_name)', { count: 'exact' })
    .eq('user_id', viewingUserId)
