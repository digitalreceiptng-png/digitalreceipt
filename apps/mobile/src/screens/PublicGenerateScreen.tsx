...
export default function PublicGenerateScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      {/* Integrated Header Bar with Back Button & Page Title on the Same Row */}
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ padding: 16, paddingBottom: 60 }}>
        ...
        {step === 1 && (
          <View style={styles.invoiceCard}>
            ...
            {/* Form Action Buttons (Inside Form Card) */}
        ...
        {step === 4 && (
          <View style={styles.invoiceCard}>
            ...
            <View style={{ marginTop: 24, gap: 12 }}>
              <TouchableOpacity style={[styles.btnPrimary, { flexDirection: 'row' }]} onPress={() => setShowPdf(true)}>
                <Ionicons name="eye-outline" size={20} color="#fff" style={{ marginRight: 8 }} />
                <Text style={styles.btnPrimaryText}>View PDF Invoice</Text>
              </TouchableOpacity>

              <TouchableOpacity style={[styles.btnPrimary, { flexDirection: 'row', backgroundColor: '#0f172a' }]} onPress={shareInvoice}>
...
const styles = StyleSheet.create({
  ...
  inlineActionRow: { flexDirection: 'row', gap: 12, marginTop: 24 },
  btnPrimary: {
