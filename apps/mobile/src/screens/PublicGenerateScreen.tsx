  ...
  if (generated) {
    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle={{ padding: 16 }}>
        ...
        <TouchableOpacity style={[styles.shareBtn, { flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }]} onPress={() => setShowPdf(true)}>
          <Ionicons name="eye-outline" size={20} color="#fff" style={{ marginRight: 8 }} />
          <Text style={styles.shareBtnText}>View Invoice</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.shareBtn, { flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }]} onPress={shareInvoice}>
        ...
        {showPaymentOptions && (
          <View style={styles.optionsWrap}>
            {PAYMENT_OPTIONS.map(opt => (
              ...
              >
                <Ionicons name={accepted.includes(opt) ? "checkbox" : "square-outline"} size={20} color={GREEN} style={{ marginRight: 8 }} />
