      ...
      >
        ...
        <div className="absolute z-[2] pointer-events-none" style={{ left: '-10%', top: '40%', transform: 'translateY(-50%)', width: '80vh', height: '80vh', borderRadius: '50%', background: 'radial-gradient(circle, rgba(235,240,235,0.92) 0%, rgba(220,230,220,0.80) 40%, rgba(200,215,200,0.40) 65%, transparent 80%)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ position: 'relative', width: '88%', height: '88%' }}>
            <Image src="/hero-logo.png" alt="DigitalReceipt.ng" fill className="object-contain" />
          </div>
        </div>
        {/* Twinkling stars */}
        ...
        <div className="relative z-[4] w-full flex items-center py-8 lg:py-10 xl:py-16 2xl:py-24">
          ...
          <div className="flex flex-col items-start gap-3 lg:gap-4 xl:gap-5 w-full max-w-sm lg:max-w-md xl:max-w-xl px-6 sm:px-10 lg:px-0 lg:pr-10 xl:pr-16">
            ...
            >
              Authenticated digital receipts with verification codes.<br />Customers, auditors, and regulators can confirm<br />authenticity instantly.<br />no account required to verify.
            </p>
