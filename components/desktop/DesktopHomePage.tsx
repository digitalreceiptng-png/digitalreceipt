    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse 28% 56% at 8% 35%, transparent 55%, oklch(0.22 0.105 145 / 0.85) 75%, oklch(0.22 0.105 145) 90%), linear-gradient(to right, oklch(0.22 0.105 145 / 0.5) 0%, oklch(0.22 0.105 145 / 0.65) 38%, oklch(0.22 0.105 145) 55%)' }}
        />
