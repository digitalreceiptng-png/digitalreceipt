    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse 28% 56% at 8% 35%, transparent 65%, oklch(0.22 0.105 145 / 0.85) 80%, oklch(0.22 0.105 145) 92%), linear-gradient(to right, oklch(0.22 0.105 145 / 0.15) 0%, oklch(0.22 0.105 145 / 0.55) 38%, oklch(0.22 0.105 145) 55%)' }}
        />
