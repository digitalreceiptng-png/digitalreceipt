    ...
    <div>
        ...
        <div className="relative z-[4] flex flex-col px-5 pt-6 pb-5 gap-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base text-white/90 leading-relaxed" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.5)' }}>
              Authenticated digital receipts with verification codes. Customers, auditors, and regulators can confirm authenticity instantly. No account required to verify.
            </p>
          </div>
      ...
      <section className="py-10 bg-surface border-y border-border overflow-hidden">
        ...
        <div className="relative">
          <div className="inline-flex gap-4 animate-marquee-reverse">
            {[...REVIEWS, ...REVIEWS, ...REVIEWS, ...REVIEWS].map((r, i) => <ReviewCard key={i} {...r} />)}
          </div>
        </div>
      </section>
