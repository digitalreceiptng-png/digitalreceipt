    ...
    <section className="bg-forest-light border-t border-forest/10 py-2 sm:py-3">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          ...
          {/* macOS */}
          <a
            href="https://github.com/digitalreceiptng-png/digitalreceipt/releases/latest/download/DigitalReceipt-Setup.dmg"
            className="flex items-center gap-2 bg-[#1a3728] text-white px-4 py-2 rounded-xl hover:bg-[#2d5a3d] transition-colors shadow-sm"
        ...
        <p className="text-xs text-ink-muted mt-2 opacity-60">Windows &amp; macOS available now · Android &amp; iOS coming soon</p>
      </div>
    </section>
  )
}
