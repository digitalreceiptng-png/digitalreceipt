    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <Link href="/" className="flex items-center gap-2.5" onClick={() => setOpen(false)}>
          <Image src="/logo.jpeg" alt="DigitalReceipt.ng" width={44} height={44} className="rounded-lg object-cover shrink-0" style={{ mixBlendMode: 'multiply' }} />
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-border flex items-center justify-between px-4 h-14">
        <Link href="/" className="flex items-center gap-2">
          <Image src="/logo.jpeg" alt="DigitalReceipt.ng" width={48} height={48} className="rounded-md object-cover shrink-0" style={{ mixBlendMode: 'multiply' }} />
        </Link>
